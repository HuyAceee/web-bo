...
import { useOperatingRegisterImage } from '@/composables/operating/modal/registerImage/useOperatingRegisterImage'
...
const { checkValidImage, defaultValue, altText, closeModalByPop, handleChooseImage, handleChangeAlt } = useOperatingRegisterImage(props, emits)
</script>
<template>
  <div class="wf-bg">
