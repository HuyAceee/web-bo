...
import ExhibitionCommonSearchKeywordTable from '@/components/exhibition/exhibitionCommon/ExhibitionCommonSearchKeywordTable.vue'
...
import { useExhibitionCommonSearchKeywordMngt } from '@/composables/exhibition/exhibitionCommon/useExhibitionCommonSearchKeywordMngt'
...
const {
  ...
  onSubmit,
  onReset
} = useExhibitionCommonSearchKeywordMngt()
</script>
...
<template>
  <div class="wf_border-page">
    <div class="wf-px-30 wf-py-30">
      <CommonTable>
        <CommonTableRow>
          ...
          <CommonTableTitleCell title="검색창 키워드" />
          <CommonTableContentCell>
            <WelfareInputText
              class="wf_w-180"
              size="small"
              placeholder="검색창 키워드 입력"
    ...
    <div class="wf-px-30 wf-py-30">
      <ExhibitionCommonSearchKeywordTable
        ref="refTable"
        :data="items"
...
<script lang="ts">
export default {
  name: 'ExhibitionCommonSearchKeywordMngtPage'
}
</script>
