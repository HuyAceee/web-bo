...
import {
  ...
  CategoriesTreeMenuPopupContextEmits,
  CategoriesTreeMenuPopupProps
} from '@/models/views/categories/CategoriesDepthManagementModel'
import { defineEmits, defineProps, onMounted, ref } from 'vue'

const emit = defineEmits<CategoriesTreeMenuPopupContextEmits>()
const { actions, xPosition, yPosition } = defineProps<CategoriesTreeMenuPopupProps>()
...
const emitAction = (action: CategoriesMenuPopupAction) => {
