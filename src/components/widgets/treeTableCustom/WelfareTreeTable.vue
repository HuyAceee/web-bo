...
import { ref } from 'vue'
import TreeDataTablePagination from './TreeDataTablePagination.vue'
...
<template>
  <div>
    <TreeDataTablePagination ref="tableRef" v-bind="props" :value="value" :totalRecords="totalRecords" v-on="eventEmit">
      <template #loading>
